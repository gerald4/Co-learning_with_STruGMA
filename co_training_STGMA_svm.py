...
from quasi_svm_black_box import quasiSVM
...
if __name__== "__main__":
    ...
    optimizer_sTGMA = tf.optimizers.Adam(lr = hyper_params["stgma_lr"])

    optimizer_black_box = tf.optimizers.Adam(lr = hyper_params["bb_lr"])
    ...
    diff = []
    directory = f"svm_as_bb/holdout/{dataset_name}/components_{n_components}_lambda_{str(_lambda)}_toto"
