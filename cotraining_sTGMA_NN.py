...
@tf.function
def train_step_sTGMA(data, labels, responsibilities, eta, samples, weights):
    ...
    model.projection(data, labels, responsibilities, weights)
...
if __name__== "__main__":
    ...
    diff = []
    directory = f"images_cotraining/datasets/{dataset_name}/components_{n_components}/value_{str(_lambda)}"
